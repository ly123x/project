...
<div class="dormitory">
    ...
    <div class="from">
        <el-table :data="tables" ref="tableData" style="width: 100%" :row-class-name="tableRowClassName" border>
            ...
            <el-table-column align="center" prop="name" label="房产类型" width="140">
            </el-table-column>
            <el-table-column align="center" prop="role" label="区域" width="140">
            </el-table-column>
            <el-table-column align="center" prop="names" label="面积" width="140">
            </el-table-column>
            <el-table-column align="center" prop="phone" label="几室几厅" width="140">
            </el-table-column>
            <el-table-column align="center" prop="bz" label="楼层索引（房屋编号）" width="140">
            </el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible">
            <el-form :model="addForm" ref="addForm">
                ...
                <el-form-item label="楼层索引（房屋编号）" :label-width="formLabelWidth">
