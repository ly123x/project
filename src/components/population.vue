...
<div class="dormitory">
    ...
    <div class="from">
        <el-table :data="tables" ref="tableData" style="width: 100%" :row-class-name="tableRowClassName" border>
            ...
            <el-table-column align="center" prop="name" label="业务姓名" width="140">
            </el-table-column>
            <el-table-column align="center" prop="role" label="性别" width="140">
            </el-table-column>
            <el-table-column align="center" prop="names" label="身份证号" width="140">
            </el-table-column>
            <el-table-column align="center" prop="phone" label="联系电话" width="140">
            </el-table-column>
            <el-table-column align="center" prop="bz" label="住址" width="140">
            </el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible">
            <el-form :model="addForm" ref="addForm">
                <el-form-item label="业务姓名" :label-width="formLabelWidth">
